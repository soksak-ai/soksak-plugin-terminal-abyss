...
if (workflow.includes("repository: soksak-ai/soksak-spec")) throw new Error("release workflow must not checkout dependency source");
...
requireText("node-version-file: soksak-plugins/soksak-plugin-terminal-abyss/.node-version", "Node owner file");
requireText("package_json_file: soksak-plugins/soksak-plugin-terminal-abyss/frontend/package.json", "pnpm owner file");
